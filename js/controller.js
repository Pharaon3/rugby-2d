  ...
  var interval = setInterval(function () {
    ...
    if(isGoal){
      ...
      if(gameState[currentState]['goaltypeid'] == '29'){
        setCenterFrame('PENALTY_POINTS', teamNames[gameState[currentState]['team']])
      }
      ...
      if(gameState[currentState] && gameState[currentState]['team'] == 'home' && gameState[currentState]['name']){
        document.getElementById('homeState').textContent = gameState[currentState]['name']
      }
      else if(gameState[currentState]  && gameState[currentState]['team'] == 'away' && gameState[currentState]['name']){
        ...
        if(gameState[currentState]) {
          setCenterFrame(gameState[currentState]['name'], homeScore + ' - ' + awayScore)
          if(gameState[currentState]['name'] == '1st half')setCenterFrame('Half time', homeScore + ' - ' + awayScore)
        } 
      }
    }
  }, timeInterval)
